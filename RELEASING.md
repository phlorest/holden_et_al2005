...
```shell
cldfbench makecldf --glottolog-version v5.2 --with-zenodo --with-cldfreadme cldfbench_holden_et_al2005.py
pytest
```

Recreate the README:
```shell
cldfbench readme cldfbench_holden_et_al2005.py
```

Run Phlorest-specific checks on the data:
```shell
phlorest check --with-R cldfbench_holden_et_al2005.py
```
...
```shell
phlorest release cldfbench_holden_et_al2005.py vX.Y
```
